...
const postRoutes = (app) => {
    ...
    app.post('/start_bot', (req, res) => {
      ...
      child = fork('./modules/bot/bot_start.js', [data]);
    ...
    app.post('/trade', (req, res) => {
      ...
      // Lancer la fonction monitor_price dans un nouveau processus
      child = fork('./modules/trades/monitor_price.js', [timeframe, price, position, amount, tp_percentage, tp_amount, sl_percentage, tp_switch, sl_switch, pair , exchange]);
